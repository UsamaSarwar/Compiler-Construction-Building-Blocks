...
public class OutputWindow extends javax.swing.JFrame {
     ...
     * @param lR1Parser
     */
    public OutputWindow(LR0Parser lr0Parser) {
    ...
    private void initComponents() {
        ...
        result.setText("Acceptance Status");
    ...
    private void jTabbedPane1StateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_jTabbedPane1StateChanged
        ...
        switch (jTabbedPane1.getSelectedIndex()) {
            ...
            for (String s : lr0Parser.getGrammar().getFirstSets().keySet()) {
                firstSet += s + " : " + lr0Parser.getGrammar().getFirstSets().get(s) + "\n";
            }

            output1.append(firstSet);
            first_panel.add(result_scroll_panel1);
            break;
            case 2:
            String followSet = "";
            for (String s : lr0Parser.getGrammar().getFallowSets().keySet()) {
                followSet += s + " : " + lr0Parser.getGrammar().getFallowSets().get(s) + "\n";
            }
            output2.setText(followSet);
