...
public class OutputWindow extends javax.swing.JFrame {
    ...
    public OutputWindow(String parserKind, LR1Parser lR1Parser) {
    ...
    private void initComponents() {
        ...
        jTabbedPane1.addTab("Follow Set (Optional)", follow_set_panel);
        ...
        input_box.setBorder(javax.swing.BorderFactory.createTitledBorder("Input String"));
    ...
    private void jTabbedPane1StateChanged(javax.swing.event.ChangeEvent evt) {//GEN-FIRST:event_jTabbedPane1StateChanged
        ...
        switch (jTabbedPane1.getSelectedIndex()) {
            ...
            case 0:
            if (parserKind.equals("CLR(1)") || parserKind.equals("LALR(1)")) {
                String str = "";
